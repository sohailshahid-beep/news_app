      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
          <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
            <a
              href="/"
              className="flex justify-center xl:justify-start font-bold text-4xl sm:text-5xl text-white-900 dark:text-white"
          ...
          <div className="lg:mx-auto text-left">
            <h4 className="text-lg text-white font-medium mb-7">Pak News</h4>
        ...
        <div className="py-7 border-t border-gray-700">
          <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
            ...
            <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0">
              ...
              <a
                href="https://instagram.com/pagedone"
                className="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-indigo-600 transition-colors"
              ...
              <a
                href="https://youtube.com/pagedone"
                className="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-indigo-600 transition-colors"
